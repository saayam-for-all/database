...
-- Table: volunteer_ratings
CREATE TABLE IF NOT EXISTS virginia_dev_saayam_rdbms.volunteer_ratings (
...
-- Indexes for volunteer_ratings
CREATE INDEX IF NOT EXISTS idx_volunteer_rating_user_id ON virginia_dev_saayam_rdbms.volunteer_ratings (user_id);
CREATE INDEX IF NOT EXISTS idx_volunteer_rating_request_id ON virginia_dev_saayam_rdbms.volunteer_ratings (request_id);
