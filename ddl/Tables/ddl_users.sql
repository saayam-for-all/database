...
CREATE TABLE IF NOT EXISTS virginia_dev_saayam_rdbms.users (
	...
	CONSTRAINT fk_users_language_1 FOREIGN KEY (language_1) REFERENCES virginia_dev_saayam_rdbms.supporting_languages(language_id) ON DELETE SET NULL,
	CONSTRAINT fk_users_language_2 FOREIGN KEY (language_2) REFERENCES virginia_dev_saayam_rdbms.supporting_languages(language_id) ON DELETE SET NULL,
	CONSTRAINT fk_users_language_3 FOREIGN KEY (language_3) REFERENCES virginia_dev_saayam_rdbms.supporting_languages(language_id) ON DELETE SET NULL,
);
